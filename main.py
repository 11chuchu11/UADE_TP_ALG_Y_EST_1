...
def main():
    ...
    #cargaTurnos(codsPrueba, codnomPrueba, legajos, nombre, email, operaciones, puestosAtencion, liConformidad, liEstadoConsulta)
    #generarInformes(codsPrueba, codnomPrueba,legajos, nombre, email, operaciones, puestosAtencion, liConformidad, liEstadoConsulta)
